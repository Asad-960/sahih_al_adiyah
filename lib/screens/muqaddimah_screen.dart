              ...
              Text.rich(
                TextSpan(
                  ...
                  children: [
                    ...
                    const TextSpan(
                      text:
                          'الْحَمْدُ لِلَّهِ الَّذِي لَمْ يَجْعَلْ بَيْنَهُ وَبَيْنَ عِبَادِهِ وَاسِطَةً فِي الدُّعَاءِ، وَهُوَ الْقَائِلُ: ',
                    ),
                    TextSpan(
                      text:
                    ...
                    const TextSpan(
                      text:
                          '، وَالصَّلَاةُ وَالسَّلَامُ عَلَى رَسُولِهِ الْأَمِينِ، الْقَائِلِ: «الدُّعَاءُ هُوَ الْعِبَادَةُ». ',
                    ),
                    TextSpan(text: '[أحمد وغيره]', style: referenceStyle),
                    const TextSpan(
                      text:
                          '، وَالْقَائِلِ: «مَنْ لَمْ يَسْأَلِ اللَّهَ؛ يَغْضَبْ عَلَيْهِ». ',
                    ),
                    ...
                    const TextSpan(
                      text:
                          'وَبَعْدُ: فَإِنَّ دُعَاءَ اللَّهِ وَالْإِلْحَاحَ عَلَيْهِ؛ شَأْنُ نَبِيِّنَا مُحَمَّدٍ ﷺ، وَشَأْنُ الْأَنْبِيَاءِ مِنْ قَبْلِهِ، وَشَأْنُ الصَّالِحِينَ، وَلَيْسَ أَمْرٌ مِنْ أُمُورِ الدُّنْيَا وَالْآخِرَةِ إِلَّا وَقَدْ جَعَلَ اللَّهُ عَزَّ وَجَلَّ مِفْتَاحَ تَحْقِيقِهِ وَالْوُصُولِ إِلَيْهِ: الدُّعَاءُ.\n\n',
                    ),

                    // --- Page 2 Text ---
                    const TextSpan(
                      text:
                          'وَاللَّهُ يُحِبُّ الْمُلِحِّينَ، وَيُجِيبُ دَعْوَةَ الْمُضْطَرِّينَ:\n',
                    ),
                    TextSpan(
                      text: '﴿أَمَّن يُجِيبُ الْمُضْطَرَّ إِذَا دَعَاهُ﴾ ',
                      style: quranicStyle,
                    ),
